...
1. BACA ISI KONTEN TEKS. Soal harus berasal dari "SUBSTANSI MATERI" dokumen tersebut (misalnya ilmu pengetahuan, teori, konsep, sejarah yang dibahas di dalamnya).
2. Anda HARUS MENDETEKSI bahasa utama yang digunakan dalam teks sumber materi tersebut (misalnya Arab, Latin, Indonesia, Inggris).
3. Anda HARUS menulis "question" (soal) dan "options" (pilihan jawaban) MENGGUNAKAN BAHASA DAN AKSARA YANG SAMA PERSIS dengan teks sumber materi.
4. Jika materi membahas teks Arab (huruf Hijaiyah), maka soal dan jawaban HARUS ditulis full dalam aksara Arab (العربية).
5. JANGAN MENERJEMAHKAN ke bahasa Indonesia jika teks sumbernya materi aslinya adalah bahasa Arab atau Latin. Tetap pertahankan bahasa aslinya.
6. Buang segala meta-data atau teks header/footer saat membaca materi. Fokus hanya pada ISI.
